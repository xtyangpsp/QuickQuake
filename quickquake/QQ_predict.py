...
def read_args():
    ...
    parser.add_argument("--min_p_prob", default=0.7, type=float, help="Probability threshold for P pick")
    parser.add_argument("--min_s_prob", default=0.7, type=float, help="Probability threshold for S pick")
